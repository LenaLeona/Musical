...
//store convenient static functions
public class G {
    ...
    //-----------------------------------Vector-----------------------------------------------//
    //variables live in 3 places: static variables(live forever),member/object variables(field names), function/local variable
    public static class V {
        ...
        public static class Transform {
            int dx, dy, n, d;
            // oh = old height, ow = old width, nW = new width, nH = new height
    ...
    //____________Polyline____________
